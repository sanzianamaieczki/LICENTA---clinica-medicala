...
//    ) {
//        try{
//            List<AppointmentDTO> appointments = appointmentService.getAppointmentByFilters(is_deleted, appointment_date, appointment_status);
...
//        try{
//            AppointmentDTO appointment = appointmentService.addAppointment(appointmentDTO);
...
//    public ResponseEntity<?> updateAppointment(@PathVariable Integer id_appointment, @RequestBody Map<String, Object> updates) {
//        try{
//            AppointmentDTO appointmentDTO = appointmentService.updateAppointment(id_appointment, updates);
//            return ResponseEntity.status(HttpStatus.OK).body(appointmentDTO);
//        }catch (HttpClientErrorException.UnprocessableEntity e){
//            return ResponseEntity.status(HttpStatus.UNPROCESSABLE_ENTITY).body(e.getMessage());
//        }catch (HttpClientErrorException.Conflict e){
