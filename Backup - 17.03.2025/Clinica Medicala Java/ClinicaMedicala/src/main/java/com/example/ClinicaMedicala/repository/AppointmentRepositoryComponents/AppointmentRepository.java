...
//
//    @Query("SELECT a FROM Appointment a WHERE a.medicalService.id_medical_service = :id_medical_service")
//    List<Appointment> findAppointmentsByMedicalServicesId(int id_medical_service);
//}
