...
public class DoctorMedicalServicesDTO {
    ...
    public DoctorMedicalServicesDTO(DoctorMedicalServices doctorMedicalServices) {
        ...
        this.id_medical_service = doctorMedicalServices.getMedicalService().getId_medical_service();
        ...
        this.medicalService= new MedicalServicesDTO(doctorMedicalServices.getMedicalService());
